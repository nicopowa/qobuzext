...
Qobuz downloader [Web Extension](https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions)  
...
There is no data collection or analytics tracking. The only network request made outside of qobuz.com is to retrieve [manifest.json](https://github.com/nicopowa/qobuzext/blob/main/manifest.json) from this repository to check for updates.
...
- Download [qobuzext_vX.X_chromium.zip](https://github.com/nicopowa/qobuzext/releases)
- Extract archive
- Open [Extensions tab](https://support.google.com/chrome_webstore/answer/2664769#cke_bm_1361S)
- Enable **Developer mode**
- Click **Load unpacked**
- Select extracted **qobuzext** directory
...
- QobuzExt is **not published** on [AMO](https://addons.mozilla.org)
...
><br/>
>
>- Download [qobuzext_vX.X.xpi](https://github.com/nicopowa/qobuzext/releases)
>- Paste this URL into the address bar and press Enter  
>	`about:debugging#/runtime/this-firefox` 
>- Click **Load Temporary Add-on**
>- Select **qobuzext_vX.X.xpi**
>
></details>
...
- Download [qobuzext_vX.X.crx](https://github.com/nicopowa/qobuzext/releases)
